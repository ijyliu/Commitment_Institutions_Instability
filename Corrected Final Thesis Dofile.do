...
esttab miFEDF_v2elturnhog miFEDF_v2elturnhos miFEDF_v2eltvrig miFEDF_e_wbgi_pve miFEDF_instabEvent using "multIndFEDF.rtf", label replace compress
...
esttab imiFEDJ_v2elturnhog imiFEDJ_v2elturnhos imiFEDJ_v2eltvrig imiFEDJ_e_wbgi_pve imiFEDJ_instabEvent using "imultIndFEDJ.rtf", label replace compress
...
esttab imiolsDF_v2elturnhog imiolsDF_v2elturnhos imiolsDF_v2eltvrig imiolsDF_e_wbgi_pve imiolsDF_instabEvent using "imultIndOLSDF.rtf", label replace compress
...
esttab lFDJ_bv2elturnhog lFDJ_bv2elturnhos lFDJ_bv2eltvrig lFDJ_be_wbgi_pve lFDJ_binstabEvent using "logitFEMultIndDJ.rtf", label replace compress

esttab lFDJ_b2v2elturnhog lFDJ_b2v2elturnhos lFDJ_b2v2eltvrig lFDJ_b2e_wbgi_pve using "logitFEMultInd2DJ.rtf", label replace compress
...
esttab lFDF_bv2elturnhog lFDF_bv2elturnhos lFDF_bv2eltvrig lFDF_be_wbgi_pve lFDF_binstabEvent using "logitFEMultIndDF.rtf", label replace compress
...
esttab cbinstabEventDJ using "coeffsJustBinInstabEventDJ.rtf", label replace compress
xtlogit binstabEvent `primCommInstVarsDJ', fe
eststo mlf_binstabEventDJ: margins, dydx(`primCommInstVarsDJ') post
esttab mlf_binstabEventDJ using "margsJustBinInstabEventDJ.rtf", label replace compress

* DF
xtlogit binstabEvent `primCommInstVarsDF', fe
eststo cbinstabEventDF
esttab cbinstabEventDF using "coeffsJustBinInstabEventDF.rtf", label replace compress
xtlogit binstabEvent `primCommInstVarsDF', fe
...
esttab bolsDJ_v2elturnhog bolsDJ_v2elturnhos bolsDJ_v2eltvrig bolsDJ_e_wbgi_pve bolsDJ_instabEvent using "binaryIndOLSDJ.rtf", label replace compress
esttab bFEDJ_v2elturnhog bFEDJ_v2elturnhos bFEDJ_v2eltvrig bFEDJ_e_wbgi_pve bFEDJ_instabEvent using "binaryIndFEDJ.rtf", label replace compress
...
esttab bolsDF_v2elturnhog bolsDF_v2elturnhos bolsDF_v2eltvrig bolsDF_e_wbgi_pve bolsDF_instabEvent using "binaryIndOLSDF.rtf", label replace compress
...
esttab fullcmiolsDJ_v2elturnhog fullcmiolsDJ_v2elturnhos fullcmiolsDJ_v2eltvrig fullcmiolsDJ_e_wbgi_pve fullcmiolsDJ_instabEvent using "fullcmultIndOLSDJ.rtf", label replace compress

esttab fullcmiFEDJ_v2elturnhog fullcmiFEDJ_v2elturnhos fullcmiFEDJ_v2eltvrig fullcmiFEDJ_e_wbgi_pve fullcmiFEDJ_instabEvent using "fullcmultIndFEDJ.rtf", label replace compress
...
esttab fullcmiolsDF_v2elturnhog fullcmiolsDF_v2elturnhos fullcmiolsDF_v2eltvrig fullcmiolsDF_e_wbgi_pve fullcmiolsDF_instabEvent using "fullcmultIndOLSDF.rtf", label replace compress

esttab fullcmiFEDF_v2elturnhog fullcmiFEDF_v2elturnhos fullcmiFEDF_v2eltvrig fullcmiFEDF_e_wbgi_pve fullcmiFEDF_instabEvent using "fullcmultIndFEDF.rtf", label replace compress
...
esttab nccmiolsDJ_v2elturnhog nccmiolsDJ_v2elturnhos nccmiolsDJ_v2eltvrig nccmiolsDJ_e_wbgi_pve nccmiolsDJ_instabEvent using "nccmultIndOLSDJ.rtf", label replace compress

esttab nccmiFEDJ_v2elturnhog nccmiFEDJ_v2elturnhos nccmiFEDJ_v2eltvrig nccmiFEDJ_e_wbgi_pve nccmiFEDJ_instabEvent using "nccmultIndFEDJ.rtf", label replace compress
...
esttab nccmiolsDF_v2elturnhog nccmiolsDF_v2elturnhos nccmiolsDF_v2eltvrig nccmiolsDF_e_wbgi_pve nccmiolsDF_instabEvent using "nccmultIndOLSDF.rtf", label replace compress

esttab nccmiFEDF_v2elturnhog nccmiFEDF_v2elturnhos nccmiFEDF_v2eltvrig nccmiFEDF_e_wbgi_pve nccmiFEDF_instabEvent using "nccmultIndFEDF.rtf", label replace compress
...
esttab ifivs4_v2elturnhog ifivs4_v2elturnhos ifivs4_v2eltvrig ifivs4_e_wbgi_pve using "ifivs4.rtf", label replace compress
...
esttab hkmiFEDJ_v2elturnhog hkmiFEDJ_v2elturnhos hkmiFEDJ_v2eltvrig hkmiFEDJ_e_wbgi_pve hkmiFEDJ_instabEvent using "hkmultIndFEDJ.rtf", label replace compress
...
esttab hkmiFEDF_v2elturnhog hkmiFEDF_v2elturnhos hkmiFEDF_v2eltvrig hkmiFEDF_e_wbgi_pve hkmiFEDF_instabEvent using "hkmultIndFEDF.rtf", label replace compress
...
esttab lkmiFEDJ_v2elturnhog lkmiFEDJ_v2elturnhos lkmiFEDJ_v2eltvrig lkmiFEDJ_e_wbgi_pve lkmiFEDJ_instabEvent using "lkmultIndFEDJ.rtf", label replace compress
...
esttab lkmiFEDF_v2elturnhog lkmiFEDF_v2elturnhos lkmiFEDF_v2eltvrig lkmiFEDF_e_wbgi_pve lkmiFEDF_instabEvent using "lkmultIndFEDF.rtf", label replace compress
...
esttab ikmiFEDJ_v2elturnhog ikmiFEDJ_v2elturnhos ikmiFEDJ_v2eltvrig ikmiFEDJ_e_wbgi_pve ikmiFEDJ_instabEvent using "ikmultIndFEDJ.rtf", label replace compress
...
esttab ikmiFEDF_v2elturnhog ikmiFEDF_v2elturnhos ikmiFEDF_v2eltvrig ikmiFEDF_e_wbgi_pve ikmiFEDF_instabEvent using "ikmultIndFEDF.rtf", label replace compress
...
esttab hoshogmiFEDJ_v2elturnhog hoshogmiFEDJ_v2elturnhos using "hoshogmultIndFEDJ.rtf", label replace compress
...
esttab hoshogmiFEDF_v2elturnhog hoshogmiFEDF_v2elturnhos using "hoshogmultIndFEDF.rtf", label replace compress
...
esttab llpFEDJ_v2eltvrig using "llpFEDJ.rtf", label replace compress
*DF
xtreg v2eltvrig i.irregtd##c.v2lglegplo c.RRrate##c.v2lglegplo, fe cluster(country)
eststo llpFEDF_v2eltvrig
esttab llpFEDF_v2eltvrig using "llpFEDF.rtf", label replace compress
...
esttab idemcmiFEDJ_v2elturnhog idemcmiFEDJ_v2elturnhos idemcmiFEDJ_v2eltvrig idemcmiFEDJ_e_wbgi_pve idemcmiFEDJ_instabEvent using "binarydemcmultIndFEDJ.rtf", label replace compress
...
esttab demFEDJ_v2elturnhog demFEDJ_v2elturnhos demFEDJ_v2eltvrig demFEDJ_e_wbgi_pve demFEDJ_instabEvent using "democraciesFEDJ.rtf", label replace compress
* DF
foreach stabVar in `StabVars' {
xtreg `stabVar' `primCommInstVarsDF' if deme_polity2 == 1, fe cluster(country)
eststo demFEDF_`stabVar'
}
esttab demFEDF_v2elturnhog demFEDF_v2elturnhos demFEDF_v2eltvrig demFEDF_e_wbgi_pve demFEDF_instabEvent using "democraciesFEDF.rtf", label replace compress
...
esttab nondemFEDJ_v2elturnhog nondemFEDJ_v2elturnhos nondemFEDJ_v2eltvrig nondemFEDJ_e_wbgi_pve nondemFEDJ_instabEvent using "nondemocraciesFEDJ.rtf", label replace compress
* DF
foreach stabVar in `StabVars' {
xtreg `stabVar' `primCommInstVarsDF' if deme_polity2 == 0, fe cluster(country)
eststo nondemFEDF_`stabVar'
}
esttab nondemFEDF_v2elturnhog nondemFEDF_v2elturnhos nondemFEDF_v2eltvrig nondemFEDF_e_wbgi_pve nondemFEDF_instabEvent using "nondemocraciesFEDF.rtf", label replace compress
...
esttab ifullicmiFEDJ_v2elturnhog ifullicmiFEDJ_v2elturnhos ifullicmiFEDJ_v2eltvrig ifullicmiFEDJ_e_wbgi_pve ifullicmiFEDJ_instabEvent using "ifullicmultIndFEDJ.rtf", label replace compress
...
esttab ifullicmiFEDF_v2elturnhog ifullicmiFEDF_v2elturnhos ifullicmiFEDF_v2eltvrig ifullicmiFEDF_e_wbgi_pve ifullicmiFEDF_instabEvent using "ifullicmultIndFEDF.rtf", label replace compress
...
esttab lagsDJ_v2elturnhog lagsDJ_v2elturnhos lagsDJ_v2eltvrig lagsDJ_e_wbgi_pve lagsDJ_instabEvent using "lagsDJ.rtf", label replace compress
eststo clear
*DF
foreach stabVar in `StabVars' {
...
esttab lagsDF_v2elturnhog lagsDF_v2elturnhos lagsDF_v2eltvrig lagsDF_e_wbgi_pve lagsDF_instabEvent using "lagsDF.rtf", label replace compress
eststo clear
...
esttab ordLogv2elturnhogDJ ordLogv2elturnhosDJ ordLogv2eltvrigDJ using "ordLogDJ.rtf", label replace compress
eststo clear
...
esttab ordLogv2elturnhogDF ordLogv2elturnhosDF ordLogv2eltvrigDF using "ordLogDF.rtf", label replace compress
eststo clear
...
esttab lagordLogv2elturnhogDJ lagordLogv2elturnhosDJ lagordLogv2eltvrigDJ laglogInstabDJ using "lagordLogLogDJ.rtf", label replace compress
eststo clear
...
esttab lagordLogv2elturnhogDF lagordLogv2elturnhosDF lagordLogv2eltvrigDF laglogInstabDF using "lagordLogLogDF.rtf", label replace compress
eststo clear
...
eststo a12
esttab a11 a12 using "irregtdHOGalone.rtf", label replace compress

reg v2elturnhog tinoff, robust
eststo a21
xtreg v2elturnhog tinoff, fe vce(cluster country)
eststo a22
esttab a21 a22 using "timeinoffHOGalone.rtf", label replace compress
...
eststo wbRRFE
esttab wbRROLS wbRRFE using "WBratesalone.rtf", label replace compress

reg instabEvent RRrate, robust
eststo instabRROLS
xtreg instabEvent RRrate, fe vce(cluster country)
eststo instabRRFE
esttab instabRROLS instabRRFE using "instabRRalone.rtf", label replace compress
...
esttab cordLogv2elturnhogDJ cordLogv2elturnhosDJ cordLogv2eltvrigDJ using "coeffordLogDJ.rtf", label replace compress
eststo clear
...
esttab intlagsDJv2elturnhog intlagsDJv2elturnhos intlagsDJv2eltvrig intlagsDJe_wbgi_pve intlagsDJinstabEvent using "intlagsDJ.rtf", label replace compress
eststo clear
*DF
foreach stabVar in `StabVars' {
...
esttab intlagsDFv2elturnhog intlagsDFv2elturnhos intlagsDFv2eltvrig intlagsDFe_wbgi_pve intlagsDFinstabEvent using "intlagsDF.rtf", label replace compress
eststo clear
...
esttab intlagordLogv2elturnhogDJ intlagordLogv2elturnhosDJ intlagordLogv2eltvrigDJ intlaglogInstabDJ using "intlagordLogLogDJ.rtf", label replace compress
eststo clear
...
esttab intlagordLogv2elturnhogDF intlagordLogv2elturnhosDF intlagordLogv2eltvrigDF intlaglogInstabDF using "intlagordLogLogDF.rtf", label replace compress
eststo clear
...
esttab demIfivs_v2elturnhog demIfivs_v2elturnhos demIfivs_v2eltvrig demIfivs_e_wbgi_pve demIfivs_instabEvent using "demIfivs.rtf", label replace compress
...
esttab demIfivs2_v2elturnhog demIfivs2_v2elturnhos demIfivs2_v2eltvrig demIfivs2_e_wbgi_pve demIfivs2_instabEvent using "demIfivs2.rtf", label replace compress
...
esttab demIfivs3_v2elturnhog demIfivs3_v2elturnhos demIfivs3_v2eltvrig demIfivs3_e_wbgi_pve demIfivs3_instabEvent using "demIfivs3.rtf", label replace compress
...
esttab demIfivs4_v2elturnhog demIfivs4_v2elturnhos demIfivs4_v2eltvrig demIfivs4_e_wbgi_pve using "demIfivs4.rtf", label replace compress
...
esttab ndemIfivs_v2elturnhog ndemIfivs_v2elturnhos ndemIfivs_v2eltvrig ndemIfivs_e_wbgi_pve ndemIfivs_instabEvent using "ndemIfivs.rtf", label replace compress
...
esttab ndemIfivs2_v2elturnhog ndemIfivs2_v2elturnhos ndemIfivs2_v2eltvrig ndemIfivs2_e_wbgi_pve ndemIfivs2_instabEvent using "ndemIfivs2.rtf", label replace compress
...
*esttab ndemIfivs3_v2elturnhog ndemIfivs3_v2elturnhos ndemIfivs3_v2eltvrig ndemIfivs3_e_wbgi_pve ndemIfivs3_instabEvent using "ndemIfivs3.rtf", label replace compress
...
*esttab ndemIfivs4_v2elturnhog ndemIfivs4_v2elturnhos ndemIfivs4_v2eltvrig ndemIfivs4_e_wbgi_pve using "ndemIfivs4.rtf", label replace compress
...
esttab hiKfivs_v2elturnhog hiKfivs_v2elturnhos hiKfivs_v2eltvrig hiKfivs_e_wbgi_pve hiKfivs_instabEvent using "hiKfivs.rtf", label replace compress
...
esttab hiKfivs2_v2elturnhog hiKfivs2_v2elturnhos hiKfivs2_v2eltvrig hiKfivs2_e_wbgi_pve hiKfivs2_instabEvent using "hiKfivs2.rtf", label replace compress
...
esttab hiKfivs3_v2elturnhog hiKfivs3_v2elturnhos hiKfivs3_v2eltvrig hiKfivs3_e_wbgi_pve hiKfivs3_instabEvent using "hiKfivs3.rtf", label replace compress
...
esttab hiKfivs4_v2elturnhog hiKfivs4_v2elturnhos hiKfivs4_v2eltvrig hiKfivs4_e_wbgi_pve using "hiKfivs4.rtf", label replace compress
...
esttab lowKIfivs_v2elturnhog lowKIfivs_v2elturnhos lowKIfivs_v2eltvrig lowKIfivs_e_wbgi_pve lowKIfivs_instabEvent using "lowKIfivs.rtf", label replace compress
...
esttab lowKIfivs2_v2elturnhog lowKIfivs2_v2elturnhos lowKIfivs2_v2eltvrig lowKIfivs2_e_wbgi_pve lowKIfivs2_instabEvent using "lowKIfivs2.rtf", label replace compress
...
*esttab lowKIfivs3_v2elturnhog lowKIfivs3_v2elturnhos lowKIfivs3_v2eltvrig lowKIfivs3_e_wbgi_pve lowKIfivs3_instabEvent using "lowKIfivs3.rtf", label replace compress
...
esttab lowKIfivs4_v2elturnhog lowKIfivs4_v2elturnhos lowKIfivs4_v2eltvrig lowKIfivs4_e_wbgi_pve using "lowKIfivs4.rtf", label replace compress
...
esttab demintlagsDJ_v2elturnhog demintlagsDJ_v2elturnhos demintlagsDJ_v2eltvrig demintlagsDJ_e_wbgi_pve demintlagsDJ_instabEvent using "demintlagsDJ.rtf", label replace compress
eststo clear
*DF
foreach stabVar in `StabVars' {
...
esttab demintlagsDF_v2elturnhog demintlagsDF_v2elturnhos demintlagsDF_v2eltvrig demintlagsDF_e_wbgi_pve demintlagsDF_instabEvent using "demintlagsDF.rtf", label replace compress
eststo clear
...
esttab demIntLOLogHOGDJ demIntLOLogHOSDJ demintlagordLogLHDJ demintlaglogInstabDJ using "demintlagordLogLogDJ.rtf", label replace compress
eststo clear
...
esttab demintlagordLogHOGDF demintlagordLogHOSDF demintlagordLogLHDF demintlaglogInstabDF using "demintlagordLogLogDF.rtf", label replace compress
eststo clear
...
esttab kapintlagsDJ_v2elturnhog kapintlagsDJ_v2elturnhos kapintlagsDJ_v2eltvrig kapintlagsDJ_e_wbgi_pve kapintlagsDJ_instabEvent using "kapintlagsDJ.rtf", label replace compress
eststo clear
*DF
foreach stabVar in `StabVars' {
...
esttab kapintlagsDF_v2elturnhog kapintlagsDF_v2elturnhos kapintlagsDF_v2eltvrig kapintlagsDF_e_wbgi_pve kapintlagsDF_instabEvent using "kapintlagsDF.rtf", label replace compress
eststo clear
...
esttab kapintlagordLogHOGDJ kapintlagordLogHOSDJ kapintlagordLogLHDJ kapintlaglogInstabDJ using "kapintlagordLogLogDJ.rtf", label replace compress
eststo clear
...
esttab kapintlagordLogHOGDF kapintlagordLogHOSDF kapintlagordLogLHDF kapintlaglogInstabDF using "kapintlagordLogLogDF.rtf", label replace compress
eststo clear
...
esttab hoshogfivs_v2elturnhog hoshogfivs_v2elturnhos hoshogfivs_v2eltvrig hoshogfivs_e_wbgi_pve hoshogfivs_instabEvent using "hoshogfivs.rtf", label replace compress
...
esttab hoshogfivs2_v2elturnhog hoshogfivs2_v2elturnhos hoshogfivs2_v2eltvrig hoshogfivs2_e_wbgi_pve hoshogfivs2_instabEvent using "hoshogfivs2.rtf", label replace compress
...
esttab hoshogfivs3_v2elturnhog hoshogfivs3_v2elturnhos hoshogfivs3_v2eltvrig hoshogfivs3_e_wbgi_pve hoshogfivs3_instabEvent using "hoshogfivs3.rtf", label replace compress
...
esttab hoshogfivs4_v2elturnhog hoshogfivs4_v2elturnhos hoshogfivs4_v2eltvrig hoshogfivs4_e_wbgi_pve using "hoshogfivs4.rtf", label replace compress
...
esttab NOhoshogIfivs_v2elturnhog NOhoshogIfivs_v2elturnhos NOhoshogIfivs_v2eltvrig NOhoshogIfivs_e_wbgi_pve NOhoshogIfivs_instabEvent using "NOhoshogIfivs.rtf", label replace compress
...
esttab NOhoshogIfivs2_v2elturnhog NOhoshogIfivs2_v2elturnhos NOhoshogIfivs2_v2eltvrig NOhoshogIfivs2_e_wbgi_pve NOhoshogIfivs2_instabEvent using "NOhoshogIfivs2.rtf", label replace compress
...
esttab NOhoshogIfivs3_v2elturnhog NOhoshogIfivs3_v2elturnhos NOhoshogIfivs3_v2eltvrig NOhoshogIfivs3_e_wbgi_pve NOhoshogIfivs3_instabEvent using "NOhoshogIfivs3.rtf", label replace compress
...
esttab NOhoshogIfivs4_v2elturnhog NOhoshogIfivs4_v2elturnhos NOhoshogIfivs4_v2eltvrig NOhoshogIfivs4_e_wbgi_pve using "NOhoshogIfivs4.rtf", label replace compress
...
esttab sglagDJ_v2elturnhog sglagDJ_v2elturnhos sglagDJ_v2eltvrig sglagDJ_e_wbgi_pve sglagDJ_instabEvent using "hoshogintlagsDJ.rtf", label replace compress
eststo clear
*DF
foreach stabVar in `StabVars' {
...
esttab sglagDF_v2elturnhog sglagDF_v2elturnhos sglagDF_v2eltvrig sglagDF_e_wbgi_pve sglagDF_instabEvent using "hoshogintlagsDF.rtf", label replace compress
eststo clear
...
esttab sglagordLogHOGDJ sglagordLogHOSDJ sglagordLogLHDJ sglaglogInstabDJ using "hoshogintlagordLogLogDJ.rtf", label replace compress
eststo clear
...
esttab sglagordLogHOGDF sglagordLogHOSDF sglagordLogLHDF sglaglogInstabDF using "hoshogintlagordLogLogDF.rtf", label replace compress
eststo clear
...
esttab llpintlagsDJ_v2elturnhog llpintlagsDJ_v2elturnhos llpintlagsDJ_v2eltvrig llpintlagsDJ_e_wbgi_pve llpintlagsDJ_instabEvent using "llpintlagsDJ.rtf", label replace compress
eststo clear
*DF
foreach stabVar in `StabVars' {
...
esttab llpintlagsDF_v2elturnhog llpintlagsDF_v2elturnhos llpintlagsDF_v2eltvrig llpintlagsDF_e_wbgi_pve llpintlagsDF_instabEvent using "llpintlagsDF.rtf", label replace compress
eststo clear
...
esttab llpintlagordLogHOGDJ llpintlagordLogHOSDJ llpintlagordLogLHDJ llpintlaglogInstabDJ using "llpintlagordLogDJ.rtf", label replace compress
eststo clear
