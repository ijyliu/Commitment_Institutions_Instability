...
\begin{document}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                \item Turnover variables: v2eltturnhog (Head of Government, HOG), v2elturnhos (Head of State, HOS), v2eltvrig (Lower House, L.H.)
    ...
    \begin{frame}
        ...
        \begin{itemize}
            \item Confirming that fixed rates decrease political and electoral stability (PBC)
            ...
            \begin{itemize}
                ...
                \item Arguably not as connected to stability as GDP per capita
            \end{itemize}
        \end{itemize}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \item De facto CBI appears to increase stability if anything, so it possibly increases welfare
            \item Combinations/interactions more destabilizing
            \item Serious implications for policy recommendations of the IMF and other international actors
            \item Robust results
            \begin{itemize}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \item Dynamic panel analysis using lags as instruments (Arellano-Bond, etc.)
