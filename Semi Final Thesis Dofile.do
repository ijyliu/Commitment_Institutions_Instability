...
label var irregtd "Irregular CB Governor Turnover"
...
label var RRrate "Exchange Rate Classification (RR)"
// Dep Variables
...
foreach stabVar in `StabVars' {
reg `stabVar' wHighCBI regtd float_rate, robust
eststo bols_`stabVar'
xtreg `stabVar' wHighCBI regtd float_rate, fe cluster(country)
eststo bFE_`stabVar'
}
...
esttab lagordLogv2elturnhog lagordLogv2elturnhos lagordLogv2eltvrig using "lagordLog.rtf", label replace compress
eststo clear
